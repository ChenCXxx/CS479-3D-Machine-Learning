...
# python train_cls.py --epochs 250 --batch_size 32 --lr 0.001
...
def step(points, labels, model):
    ...
    logits, trans3, trans64 = model(points)
    
    loss_cls = F.cross_entropy(logits, labels)

    # Paper uses 0.001 as reg weight and only when feature transform is applied.
    # No regularization for input transform.
    loss_reg = get_orthogonal_loss(trans64)  # feature transform
